...
declare module "@scom/scom-social-sdk/managers/communication.ts" {
    ...
    import { INostrFetchEventsResponse, INostrSubmitResponse, INostrCommunicationManager, INostrRestAPIManager } from "@scom/scom-social-sdk/utils/interfaces.ts";
...
declare module "@scom/scom-social-sdk/managers/eventManagerReadV1o5.ts" {
    ...
    class NostrEventManagerReadV1o5 implements ISocialEventManagerRead {
        ...
        fetchProfileRepliesCacheEvents(options: SocialEventManagerReadOptions.IFetchProfileRepliesCacheEvents): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchHomeFeedCacheEvents(options: SocialEventManagerReadOptions.IFetchHomeFeedCacheEvents): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchUserProfileCacheEvents(options: SocialEventManagerReadOptions.IFetchUserProfileCacheEvents): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchUserProfileDetailCacheEvents(options: SocialEventManagerReadOptions.IFetchUserProfileDetailCacheEvents): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchContactListCacheEvents(options: SocialEventManagerReadOptions.IFetchContactListCacheEvents): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchUserRelays(options: SocialEventManagerReadOptions.IFetchUserRelays): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        ...
        fetchCalendarEvent(options: SocialEventManagerReadOptions.IFetchCalendarEvent): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent>;
        fetchCalendarEventPosts(options: SocialEventManagerReadOptions.IFetchCalendarEventPosts): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchCalendarEventRSVPs(options: SocialEventManagerReadOptions.IFetchCalendarEventRSVPs): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchLongFormContentEvents(options: SocialEventManagerReadOptions.IFetchLongFormContentEvents): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        searchUsers(options: SocialEventManagerReadOptions.ISearchUsers): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent[]>;
        fetchPaymentRequestEvent(options: SocialEventManagerReadOptions.IFetchPaymentRequestEvent): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent>;
        fetchPaymentReceiptEvent(options: SocialEventManagerReadOptions.IFetchPaymentReceiptEvent): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").INostrEvent>;
        private getPaymentHash;
        fetchPaymentActivitiesForRecipient(options: SocialEventManagerReadOptions.IFetchPaymentActivitiesForRecipient): Promise<IPaymentActivity[]>;
        fetchPaymentActivitiesForSender(options: SocialEventManagerReadOptions.IFetchPaymentActivitiesForSender): Promise<IPaymentActivity[]>;
...
declare module "@scom/scom-social-sdk/managers/eventManagerReadV2.ts" {
    import { ISocialEventManagerRead, SocialEventManagerReadOptions } from "@scom/scom-social-sdk/utils/interfaces.ts";
    import { INostrRestAPIManager } from "@scom/scom-social-sdk/managers/communication.ts";
...
declare module "@scom/scom-social-sdk/managers/dataManager.ts" {
    import { ICalendarEventDetailInfo, ICalendarEventInfo, IChannelInfo, ICheckIfUserHasAccessToCommunityOptions, ICommunity, ICommunityDetailMetadata, ICommunityInfo, ICommunityLeaderboard, ICommunityMember, ICommunityPostScpData, ICommunitySubscription, IConversationPath, IDecryptPostPrivateKeyForCommunityOptions, IEthWalletAccountsInfo, ILocationCoordinates, ILongFormContentInfo, IMessageContactInfo, INewCommunityInfo, INftSubscription, INostrEvent, INostrMetadata, INostrMetadataContent, INoteActions, INoteCommunityInfo, INoteInfo, INoteInfoExtended, IPostStats, IRetrieveChannelMessageKeysOptions, IRetrieveCommunityPostKeysByNoteEventsOptions, IRetrieveCommunityPostKeysOptions, IRetrieveCommunityThreadPostKeysOptions, ISendTempMessageOptions, ISocialDataManagerConfig, ISocialEventManagerRead, ISocialEventManagerWrite, ITrendingCommunityInfo, IUpdateCalendarEventInfo, IUpdateCommunitySubscription, IUserActivityStats, IUserProfile, SocialDataManagerOptions } from "@scom/scom-social-sdk/utils/interfaces.ts";
    class SocialDataManager {
        ...
        sendDirectMessage(chatId: string, message: string, replyToEventId?: string): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").ISocialEventManagerWriteResult>;
        sendTempMessage(options: ISendTempMessageOptions): Promise<import("@scom/scom-social-sdk/utils/interfaces.ts").ISocialEventManagerWriteResult>;
...
declare module "@scom/scom-social-sdk/managers/dataManagerTG.ts" {
    ...
    class SocialDataManagerTG {
        ...
        createCommunity(newInfo: INewCommunityInfo, creatorId: string): Promise<ICommunityInfo>;
        updateCommunity(info: ICommunityInfo): Promise<ICommunityInfo>;
        fetchCommunitiesMembers(communities: ICommunityInfo[]): Promise<Record<string, import("@scom/scom-social-sdk/utils/interfaces.ts").ICommunityMember[]>>;
        private getEventIdToMemberMap;
        fetchCommunities(query?: string): Promise<ICommunity[]>;
        fetchMyCommunities(pubKey: string): Promise<ICommunity[]>;
        joinCommunity(community: ICommunityInfo, pubKey: string): Promise<void>;
...
declare module "@scom/scom-social-sdk/managers/index.ts" {
    ...
    import { SocialDataManagerTG } from "@scom/scom-social-sdk/managers/dataManagerTG.ts";
...
declare module "@scom/scom-social-sdk" {
    ...
    export { IFetchNotesOptions, INostrMetadataContent, INostrEvent, ICommunityBasicInfo, ICommunityInfo, ICommunityPostStatusOption, ICommunityCollectible, ICommunityLeaderboard, ICommunityScpData, INoteInfo, INoteInfoExtended, INoteCommunityInfo, ICommunityGatekeeperInfo, IUserProfile, IUserActivityStats, IPostStats, IChannelInfo, IMessageContactInfo, INewCommunityInfo, TokenType, MembershipType, PaymentModel, PaymentMethod, ProtectedMembershipPolicyType, ISubscriptionDiscountRule, IProtectedMembershipPolicy, CommunityRole, ICommunityMember, ICommunity, ITrendingCommunityInfo, CalendarEventType, ICalendarEventInfo, IUpdateCalendarEventInfo, ICalendarEventHost, ICalendarEventAttendee, ICalendarEventDetailInfo, INewCalendarEventPostInfo, ILocationCoordinates, IMqttClientOptions, ISocialDataManagerConfig, IPaymentActivity, IEthWalletAccountsInfo, ICommunityStats, ICommunityDetailMetadata, ISendTempMessageOptions, IDecryptPostPrivateKeyForCommunityOptions, INftSubscription, ICommunitySubscription, IUpdateCommunitySubscription, INostrFetchEventsResponse, ILongFormContentInfo, SocialDataManagerOptions, SocialEventManagerReadOptions, ISocialEventManagerReadResult, ISocialEventManagerWriteResult, SocialEventManagerWriteOptions, ISocialEventManagerRead, ISocialEventManagerWrite, IAllUserRelatedChannels, ICheckIfUserHasAccessToCommunityOptions, CampaignActivityType, ICommunityCampaign } from "@scom/scom-social-sdk/utils/index.ts";
